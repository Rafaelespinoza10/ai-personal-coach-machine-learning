...
class Settings:
    ...
    # JWT / Auth
    SECRET_KEY: str = os.getenv("SECRET_KEY", "cambiar-en-produccion-secret-key-muy-largo")
    JWT_ALGORITHM: str = os.getenv("JWT_ALGORITHM", "HS256")
    ACCESS_TOKEN_EXPIRE_MINUTES: int = int(os.getenv("ACCESS_TOKEN_EXPIRE_MINUTES", "10080"))  # 7 días default
